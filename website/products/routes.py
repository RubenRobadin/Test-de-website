...
from .models import Category,Brand,Addproduct,Review
...
def return_reviews(product_id):
    # Assuming you have the product_id parameter to filter reviews
...
def single_page(id):
    ...
    return render_template('products/single_page.html',product=product,brands=brands(),categories=categories(),reviews=return_reviews(id))
...
def AddReview():
    ...
    new_review = Review(score=rating, review_text=review_text, product_id=product)
    ...
    # For example, redirect back to the product page
